...
A  common theme throughout today's talks has been that working together is key to the
success of Open Research endeavour and this is where the idea of communities are important.
...
Thus communities normalise behaviour andserve to accelerate the adoption of change, in this case Open Research
...
Jenni Adams, the library Open Research Manager who has orchestrated this event, also organises monthly Open Research
Conversations which are lunchtime seminars open where invited speakers give short talks on specific topics which are
followed by discussion.

In the past Sheffield had Reproducibilitea Journal Clubs organised by Zuzzana Zagrodzka and Jim Uttley which affords an
...
Netherlandsto tell you a little bit more about INOSC and how Sheffield fits in with the wider international community.
:::
...
This brings this short talk on OSC Sheffield and I would like to invite you to sign up if
you haven't done so already. There is a website where you can register, adding details of areas you have experience of,
interest in and add a bit about yourself. Don't forget under the _Which OSC?_ field to ensure you've selected OSC
Sheffield!
:::
