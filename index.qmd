...
This is pyramid diagram is from an article by Brian Nosek, one of the co-founders of the Center for Open Science and
...
But for this to be effective the user experience of using needs to be low friction to encourage adoption and many
popular services integrate with each other and strive to make their tools accessible.

From the top of the pyramid is policy, from funders and institutions, which define what you have to do within the system
to gain recognition.

This in term defines the incentives that reward participants for participating in the system.
...
supporting and nurturing individuals who are seeking to change is via a supportive community as seeing people
undertaking new practices normalises the behavioural changes, provides support and demonstrates that open research is
possible.

Thus communities serve to accelerate the adoption of change, in this case Open Research practices, and importantly can
feed up the pyramid to the top to influence and shape policy as practices and guidelines develop and mature over time.
:::
...
...all of which encourages and enables people to take action, normalising practices and driving the cultural shift to
adopting Open Research and greater transparency. As a group this can bring about more change than any one individual
acting on their own.
:::
...
GitHub and GitLab to name a few on this graphic. There are a lot out of different tools and services out there.
...
might have experience using University of Sheffields ORDA system.
...
Jenni Adams, the library Open Research Manager and organised or OpenFest2023, organises the monthly Open Research
...
Similarly there used to be the Sheffield R User Group which met to share experiences of using the R statistical software
ecosystem for undertaking reproducible research.

Both of these groups are being restarted so keep an eye out for announcements of events in October.
...
Netherlands but is expanding thanks to the Incubator Programme they established and which has guided us the development
of OSC Sheffield.
...
This brings this short talk on Open Scholarship Community Sheffield and I would like to invite you to sign up if
you haven't done so already. The QR code on the next slide will take you to the website where you can register,
