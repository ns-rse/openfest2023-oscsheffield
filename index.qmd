...
at the bottom right of each slide and follow along.
:::
...
::: {.notes}
Good afternoon, if you'd like to view these slides on your own laptop you can go to the address at the bottom of these
slides and view them and I'd recommend doing so there are lots of links in the slides that may be useful. If you decide
to register with OSC Sheffield you can do so at the address on the bottom left but please make sure you select
*OSC Sheffield* under the *Which OSC?* field when registering.


Hi, my name is Neil Shephard, and I'm a Research Software Engineer in the Research Software Engineering Team within the
Computer Science Department. I'm not hear today to talk to you about software, but about Open Scholarship Community or
OSC in Sheffield.
...
programming with LaTeX and in time other systems. When I switched to using R for medical statistics I also learnt how to
use Git to version control my code.

Despite being co-author on a number of papers that are Open Access during my time working as a Medical Statistician the
code that underpinned the research was never formally published and all of the papers were authored in Word.
...
I'm passionate about open research as it is fundamental and underpins the enquiry process, but I came to be here stood
in front of you almost by accident. I was asked to grow the the RSE community in Sheffield and came aross the INOSC
Incubator Programme which sounded like a really good way to learn about how to grow communities. But it had a specific
purpose which I hadn't clocked from the title which was to incubate a community and as a consequence I'm now stood in
front of you today to tell you a bit about what I've learned and invite you to join the Open Scholarship Community
Sheffield.

:::

## [International Network of Open Science Communities (INOSC)](https://www.osc-international.com/)
...
They're keen to grow the network further and with that in mind the OSC Incubator Programme was born to help seed
communities in University and research institutes around the world. I had been asked to look into growing the RSE
community within Sheffield when earlier this year I saw the OSC Incubator Programme was running and decided to sign up.
:::
...
There were nine participants in this cohort of the OSC Incubator Programme including myself with researchers from Greece,
Portugal, France and Germany as well as Durham in the UK and its been great working being guided through the course by Loek and
Anita who you will hear from later and working with the other participants to understand what is involved about
establishing and growing an Open Scholarship Community.
:::

## Why Communities?


![](img/COS_Culture_and_Behavior_Change_model.png){width=75%}
...
...all of which encourages and enables people to take action, adopting Open Science practices, normalising practices and
achieving more than they might have on their own.
:::
...
And I don't think its about making massive leaps
:::
...
experience in publishing pre-registering study protocols, others in publishing data on Sheffield ORDA, yet others such
as myself have familiarity with the FAIR Principles for data sharing whilst others are familiar with FAIR for Research
Software and applying them to publishing open source software projects.
...
In the same vein the more specific a topic is the better, it ensures that the necessary detail is covered and that it is
...
articles covering Open Research practices or examples of papers where such practices have been used were run. These
tailed off around the pandemic but we will be rejuvenating them.
...
community within the University. The communities activities and direction are meant to be guided by its members so
please get involved.
:::
## INOSC

+ OSC Sheffield joins wider [International Open Science & Scholarship Community (INOSC)](https://osc-international.com/)
+ Started in Netherlands and is growing
+ Co-founder Anita Eerland
