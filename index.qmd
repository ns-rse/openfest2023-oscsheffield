...
format:
  clean-revealjs:
    ...
    # standalone: true
footer: "**Register** : [**osc-international.com/osc-sheffield/**](https://osc-international.com/osc-sheffield/) | **Slides** : [**ns-rse.github.io/openfest2023-oscsheffield**](https://ns-rse.github.io/openfest2023-oscsheffield)"
project:
  port: 7864
  host: localhost
---
...
at the bottom of each slide and follow along.
:::
...
I completed both undergraduate and post-graduate degrees here in Sheffield. I've worked as a Genetics Statistician for
10 years at University of Manchester, Western Australia and back here in Sheffield University and then spent a decade
working as a Medical Statistician in the Clinical Trials Unit within ScHARR. I had a few years working in industry
before returning to University of Sheffield last year to the role I'm currently in.

Early in my time at Manchester I developed an interest in reproducibility  when I quickly tired of re-creating tables
and copying and pasting figures into documents and taught myself literate programming with LaTeX and in time other
systems. When I switched to using R for medical statistics I also learnt how to use Git to version control my code.
...
Its great to see over the last few years the increasing prominence and importance of Open Research practices as they
underpin the validity of research.

I'm passionate about open science and saw an opportunity to learn more and help innovate by helping develop an Open
Scholarship Communities in Sheffield and am here to today to tell you a bit about it.
:::
...
::: {.column width="50%"}
![](img/osc_sheffield_profiles.png)
:::
...
::: {.notes}
Include link to [Towards wide-scale adoption of open science practices: The
