...
If you'd like to view these slides then if you're quick you can scan the QR code or you can hopefully see the Slides
link that is at the bottom of every slide. Their littered with links to further reading so you may find them useful.
...
::: {.notes}
I'm probably preaching to the converted in saying that open research is a good thing but what role do communities have
to play?
...
From the top of the pyramid is policy, which defines what you have to do within the system to gain recognition and this
determines the incentives that reward participants for participating in the system. Increasingly research funders and
the University stipulate that research output should be Open.

Whilst individuals can always go about changing their behaviour themselves, this can be challenging when the culture is
to maintain the status quo, not all colleagues are keen to change their working practices. But an effective way of
supporting and nurturing individuals who are seeking to change is via a supportive community as this helps normalise the
behavioural changes that are being undertaken, provides support and demonstrates that open research is possible.

Thus communities serves to accelerate the adoption of change, in this case Open Research practices, and importantly can
feed up the pyramid to influence and shape policy as practices and guidelines develop and mature.
:::
...
have on their own, and driving the cultural shift to adopting Open Research and greater transparency.
:::
...
Netherhlands but is growing thanks to the Incubator Programme they established and which I undertook earlier this
