...
to accelerate communication regardless of publication status. The user interface and experience of using
...
GitHub and GitLab to name a few on this graphic. There is a lot out there!
...
proportion of people with varying resilience, the late majority, and some with higher resilience, somewhat
...
In the past Sheffield had Reproducibilitea Journal Clubs organised by Zuzzana Zagrodzka and Jim Uttley which afforded an
opportunity to review and discuss different aspects of Open Research and we will be are rejuvenating these.

Similarly there used to be the Sheffield R User Group which met to share using the R statistical software and
associated ecosystem for undertaking reproducible research and with a colleague Grace Accad we will get these back up
and running.
...
I'm pleased to be able to introduce INOSC Anita Eerland from the University of Radboud in The Netherlands who is one of
the co-founders of INOSC to tell you a little bit more about INOSC and how Sheffield fits in with the wider and the
